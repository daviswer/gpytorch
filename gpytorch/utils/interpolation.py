...
class Interpolation(object):
    ...
    def interpolate(self, x_grid, x_target):
        ...
        left_boundary_pts = torch.nonzero(lower_grid_pt_idxs < 1).squeeze(1)
        ...
        right_boundary_pts = torch.nonzero(lower_grid_pt_idxs > num_grid_points - num_coefficients).squeeze(1)
